...
Lishogi is intended to be a fun and friendly environment for everyone. Please note that repeated violation of chat policy will result in loss of chat privileges.""",
      jaText = """Lishogiでは、他のプレイヤーとコミュニケーションをとる際に、*常に*親切でなければなりません。

Lishogiは、すべての人にとって楽しくフレンドリーな環境であることを意図しています。チャットポリシーを繰り返し違反した場合、チャットの特権が失われることにご注意ください。""",
    ),
    MsgPreset(
      ...
      jaText =
        """あなたの対局履歴には、意図的に負けたと思われる対局がいくつかあります。自分自身または他の誰かのレーティングを人為的に操作する試みは容認できません。この行為が続く場合、アカウントは停止されます。""",
    ),
    MsgPreset(
      ...
      jaText =
        """あなたの対局履歴には、相手が意図的にあなたに負けたと思われる対局がいくつかあります。自分自身または他の誰かのレーティングを人為的に操作する試みは容認できません。この行為が続く場合、アカウントは停止されます。""",
    ),
    MsgPreset(
      ...
      jaText = """相手の気を散らしたり、悩ませたりするために過度に引き分けを提案することは、Lishogiでは容認できません。この行為が続く場合、アカウントは停止されます。""",
    ),
    MsgPreset(
      name = "Use /report",
      enText =
        "In order to report players for bad behavior, please visit https://lishogi.org/report",
      jaText = "不正行為を行うプレイヤーを報告するには、https://lishogi.org/report にアクセスしてください",
    ),
    MsgPreset(
      name = "Use /appeal",
      enText =
      ...
      jaText =
        """Lishogiのサービス利用規約に継続的に違反したため、あなたのアカウントは制限されました。このマークに異議を唱えたい場合、またはあなたの不正行為について謝罪したい場合は、https://lishogi.org/appeal でLishogiにアピールしてください。マークを解除する可能性があります。""",
    ),
    MsgPreset(
      ...
      jaText =
        """他のプレイヤーがコンピュータ支援を使用している、またはその他の方法でチート行為をしていると非難することは、Lishogiでは容認できません。プレイヤーがチートしていると確信している場合は、そのプロフィールページの報告ボタンを使用してモデレーターに報告してください。""",
    ),
    MsgPreset(
...
Please note that repeated violation of this policy will result in loss of communication privileges.""",
      jaText = """Lishogiではスパム行為は許可されていません。
公開チャット、プライベートチャット、フォーラム、その他のコミュニケーションチャネルで、同じ内容を複数回投稿しないでください。
このポリシーの繰り返し違反は、コミュニケーション特権の喪失につながることにご注意ください。""",
    ),
    MsgPreset(
...
Please also remember that, over the long run, ratings tend to gravitate towards the player's real skill level.""",
      jaText = """レーティングのインフレを緩和するために、レーティングの払い戻しを受けるには特定の条件を満たす必要があります。このケースでは、それらの条件は満たされていませんでした。
また、長い目で見ると、レーティングはそのプレイヤーの真のスキルレベルに収束する傾向があることも覚えておいてください。""",
    ),
    MsgPreset(
...
Once this is done, you will be permitted to create a new lishogi account with a username that follows our Username policy (https://github.com/lichess-org/lila/wiki/Username-policy).""",
      jaText = """あなたのユーザー名が、誰かを不快にさせる可能性のある不適切な単語/フレーズであるか、またはあなたではない誰かになりすましているという事実により、あなたのアカウントは今後24時間以内に停止されます。
これが完了した後、あなたは私たちのユーザー名ポリシー (https://github.com/lichess-org/lila/wiki/Username-policy) に従ったユーザー名で新しいLishogiアカウントを作成することが許可されます。""",
    ),
    MsgPreset(
      ...
      jaText =
        """Lishogiのユーザー名ポリシー (https://github.com/lichess-org/lila/wiki/Username-policy) では、JSAのタイトルやLishogi Masterのタイトルを持っていることを示唆するユーザー名、または特定の有段者になりすますことはできないと規定されています。実際の有段者は、身分証明書、運転免許証、パスポートなどの身元を証明する証拠を添えて contact@lishogi.org までご連絡いただくことで確認できます。その後、私たちはあなたの身元とタイトルを確認し、あなたのタイトルはユーザー名の前とLishogiユーザープロフィールに表示されます。あなたのユーザー名またはプロフィールがタイトルを持っていることを示唆しているため、その期間内にタイトルを確認しなかった場合、2週間以内にあなたのアカウントを閉鎖する権利を留保します。""",
    ),
    MsgPreset(
      ...
      jaText =
        """私たちのチート検出アルゴリズムは、あなたのアカウントがコンピュータ支援を使用しているとしてマークしました。このマークに異議を唱えたい場合、またはあなたの不正行為について謝罪したい場合は、https://lishogi.org/appeal でLishogiにアピールしてください。マークを解除する可能性があります。もしあなたが非常に強いプレイヤー、例えば高ランクのアマチュアやプロのプレイヤーである場合、私たちはあなたの身元を証明するものが必要です。それは、IDカードや運転免許証のような文書の写真で構いません。Shogi Club 24でアクティブなアカウントをお持ちの場合、そこを通じて身元を証明することも可能です。あなたの棋力を証明するには、contact@lishogi.org までご連絡ください。""",
    ),
    MsgPreset(
...
This can be very annoying for your opponents. If this behavior continues to happen, we may be forced to terminate your account.""",
      jaText = """あなたの対局履歴には、対局を途中で放棄したり、指したり投了したりせずに時間切れを待ったりした対局がいくつかあります。
これは相手にとって非常に迷惑になる可能性があります。この行為が続く場合、アカウントを停止せざるを得なくなる可能性があります。""",
    ),
    MsgPreset(
      name = "Warning: Others",
      enText =
      ...
      jaText =
        """今後もLishogiのサービス利用規約 (https://lishogi.org/terms-of-service) に何らかの形で違反し続ける場合、あなたのアカウントは制限されます。そのような行為はお控えください。""",
    ),
  )
...
Thank you for your understanding.""",
    jaText = """数手で負けた対局がいくつかあります。レート戦では、すべての対局に勝つように試みなければならないことにご注意ください。
意図的にレート戦を負けることは「サンドバッグ行為」と呼ばれ、Lishogiでは許可されていません。
...
新しいプレイヤーをフォローするには、まず https://lishogi.org/@/$username/following で一部のプレイヤーのフォローを解除する必要があります。
