...
val `shareKIF` = new I18nKey("shareKIF")
...
val `kifTags` = new I18nKey("study:kifTags")
...
val `pasteYourKifTextHereUpToNbGames` = new I18nKey("study:pasteYourKifTextHereUpToNbGames")
}
...
val `kifPieceNotation` = new I18nKey("preferences:kifPieceNotation")
val `chessPieceSymbol` = new I18nKey("preferences:chessPieceSymbol")
val `kifLetter` = new I18nKey("preferences:kifLetter")
