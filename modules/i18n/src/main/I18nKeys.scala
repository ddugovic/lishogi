...
object I18nKeys {
  ...
  object tourArrangements {
    ...
    val `howDoesRoundRobinWorkAnswer` = new I18nKey("tourArrangements:howDoesRoundRobinWorkAnswer")
    val `howToPlayGames` = new I18nKey("tourArrangements:howToPlayGames")
    val `howToPlayGamesAnswer` = new I18nKey("tourArrangements:howToPlayGamesAnswer")
    ...
    val `howDoOrganizedTournamentsWorkAnswer` = new I18nKey("tourArrangements:howDoOrganizedTournamentsWorkAnswer")
