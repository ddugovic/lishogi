...
final class PerfsUpdater(
            ...
            .so:
              ...
              game.ratingVariant match
                ...
                case chess.variant.Atomic =>
                  updateRatings(50.0d, ratingsW.atomic, ratingsB.atomic, game)
                case chess.variant.Horde =>
                  updateRatings(-35.0d, ratingsW.horde, ratingsB.horde, game)
                case chess.variant.RacingKings =>
                  updateRatings(35.0d, ratingsW.racingKings, ratingsB.racingKings, game)
  ...
  private def updateRatings(advantage: Double, white: glicko2.Rating, black: glicko2.Rating, game: Game): Unit =
