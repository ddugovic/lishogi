...
class PerftTest extends ChessTest {
  ...
  "calculate standard shogi perfts" should {
  ...
  "calculate shogi960 perfts" should {
    // source: http://www.talkshogi.com/forum/viewtopic.php?t=55274
    "x-fen 00" in {
  ...
  "calculate tricky perfts" should {
    // source: https://shogiprogramming.wikispaces.com/Perft+Results
    "kiwipete" in {
      val game =
