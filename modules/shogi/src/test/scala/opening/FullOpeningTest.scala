...
class FullOpeningTest extends Specification {
  ...
  "by fen" should {
    "consider en passant" in {
      FullOpeningDB findByFen SFEN("rnbqkbnr/pp1p1ppp/8/2pPp3/8/8/PPP1PPPP/RNBQKBNR w KQkq - 0 3") must beNone
      FullOpeningDB findByFen SFEN("rnbqkbnr/pp1p1ppp/8/2pPp3/8/8/PPP1PPPP/RNBQKBNR w KQkq e6 0 3") must beSome
    }
    "ignore empty crazyhouse pocket" in {
      FullOpeningDB findByFen SFEN("rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR/ b KQkq - 0 1") must beSome
        .like {
