...
lazy val allModules = Seq(commonM, dbM, memoM, hubM, i18nM, socketM, ratingM, userM, oauthM, securityM, chatM, prefM, gameM, relationM, notifyM, shutupM, treeM, historyM, msgM, evalCacheM, analyseM, puzzleM, roomM, playbanM, fishnetM, roundM, reportM, simulM, perfStatM, evaluationM, tournamentM, importerM, modM, studyM, forumM, searchM, teamM, practiceM, challengeM, prismicM, timelineM, lobbyM, forumSearchM, streamerM, botM, coachM, bookmarkM, studySearchM, planM, teamSearchM, tvM, chatroomM, videoM, activityM, appealM, stormM, clasM, coordinateM, gameSearchM, pushM, blogM, apiM, setupM, eventM, learnM)
